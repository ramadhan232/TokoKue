                ...
                <div class="row">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card-header" style="background: rgb(255, 105, 180);">
                                            ...
                                            <div class="row p-t-20">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group has-danger">
                                                        ...
                                                        <input type="text" name="fname" class="form-control form-control-danger" placeholder="input your first name">
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            </div>
                                            ...
                                            <div class="row p-t-20">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="lname" class="form-control" placeholder="input your last name">
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                ...
                                <input type="submit" name="submit" class="btn btn-success" value="Save" style="background: rgb(255, 105, 180); border: none;">
                                <a href="dashboard.php" class="btn btn-warning" style="background: rgb(255, 182, 193); border: none;">Cancel</a>
                                </div>
                                </form>
                            </div>
                        </div>
