...
<body class="home">
    ...
    <!-- banner part starts -->
    <section class="hero bg-image" data-image-src="images/img/toko.png">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Toko Kue Seadanya </h1>
                <h5 class="font-white space-xs">Rasakan Cinta dalam Setiap Potong Kue</h5>
                <div class="p-3 steps">
                    <div class="step-item step1">
                        ...
                        <h4><span>1. </span>Pilih Jenis Kue</h4>
                    </div>
                    <!-- end:Step -->
                    <div class="step-item step2">
                        ...
                        <h4><span>2. </span>Order Kue nya</h4>
                    </div>
                    <!-- end:Step -->
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2 class="title">Best seller di Bulan Ini</h2>
                <p class="subTitle">Kue kami yang sering dibeli</p>
            </div>
            <div class="row">

                <?php
                // fetch records from database to display popular first 3 dishes from table
                $query_res = mysqli_query($db, "select * from kue LIMIT 3");
                while ($r = mysqli_fetch_array($query_res)) {
                    ...
                    echo ' <div class="col-xs-12 col-sm-6 col-md-4 food-item">
										<div class="food-item-wrap box">
											...
											<div class="content">
												<h5><a href="makanan.php?res_id=' . $r['rs_id'] . '">' . $r['title'] . '</a></h5>
												<div class="product-name">' . $r['slogan'] . '</div>
												<div class="price-btn-block"> <span class="price">Rp.' . $r['price'] . '</span> <a href="makanan.php?res_id=' . $r['rs_id'] . '" class="btn ctaBtn  pull-right">Order Now</a> </div>
											</div>
